...
CREATE USER IF NOT EXISTS 'astrnest'@'localhost' IDENTIFIED BY 'La917Angel';
...
INSERT INTO users (id, username, password, nickname, email, active, created_at)
VALUES (1, 'admin', '$2b$12$fhpt5EG6TBIUXoU4/BKeyukTfoJ5QBP7H6bE/tw0yg0gEkF9bGnb2', '超级管理员', 'admin@example.com', 1, NOW())
